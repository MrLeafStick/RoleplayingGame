...
namespace RoleplayingGame
{
    public class GameMechanics
    {
        public void GameLogic()
        {
            ...
            redTeam.AddCharacter(new Character("Svend", 200, 12, 60, 100, 2, 0, 0));
            redTeam.AddCharacter(new Wizard("Merlin", 100, 20, 40, 100, 5, 500, 20));

            CharacterGroup greenTeam = new CharacterGroup("Team Green");
            greenTeam.AddCharacter(new Defender("Sindy", 345, 10, 12, 100, 10, 0, 0));
            greenTeam.AddCharacter(new Character("Eric", 290, 20, 30, 100, 5, 0, 0));
            greenTeam.AddCharacter(new Damager("Kenny", 100, 100, 140, 100, 1, 0, 0));
            greenTeam.AddCharacter(new Wizard("Gandalf", 100, 50, 140, 100, 1, 500, 10));
