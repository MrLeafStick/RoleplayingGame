...
namespace RoleplayingGame
{
    public class GameMechanics
    {
        public void GameLogic()
        {
            ...
            redTeam.AddCharacter(new Defender("Thorbjorn", 484, 8, 12, 100, 5));
            redTeam.AddCharacter(new Character("Svend", 200, 12, 60, 100, 5));
            redTeam.AddCharacter(new Character("Torben", 350, 20, 40, 100, 5));
            redTeam.AddCharacter(new Damager("Freja", 600, 60, 80, 100, 5));

            CharacterGroup greenTeam = new CharacterGroup("Team Green");
            greenTeam.AddCharacter(new Defender("Sindy", 345, 10, 12, 100, 5));
            greenTeam.AddCharacter(new Character("Eric", 290, 20, 30, 100, 5));
            greenTeam.AddCharacter(new Character("Stan", 310, 30, 40, 100, 5));
            greenTeam.AddCharacter(new Damager("Kenny", 100, 100, 140, 100, 5));
